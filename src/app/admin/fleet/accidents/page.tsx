                ...
                {filteredData.map((item) => (
                  <tr key={item.id} className="transition-colors hover:bg-slate-50 dark:hover:bg-slate-800/50">
                    ...
                    <td className="px-6 py-4 font-mono font-bold">
                      <Link href={`/admin/fleet/vehicles/${item.vehicleId}`} className="hover:underline hover:text-[#1167c9]">
                        المركبة المعنية
                      </Link>
                    </td>
                    <td className="px-6 py-4 font-mono">
                      <Link href={`/admin/employees/${item.riderProfileId}`} className="hover:underline hover:text-[#1167c9]">
                        {item.riderProfileId}
                      </Link>
                    </td>
                    <td className="px-6 py-4 font-mono">

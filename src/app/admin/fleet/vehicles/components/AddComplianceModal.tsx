    ...
    try {
      if (activeTab === "Registration") {
        if (!regForm.registrationNumber.trim()) {
          toast.error("خطأ في البيانات", "يرجى إدخال رقم الاستمارة / رخصة السير");
          return;
        }
        ...
        await addVehicleRegistration(vehicleId, {
          ...
          issuingAuthority: regForm.issuingAuthority?.trim() || null,
        ...
        if (selectedFile) {
          if (selectedFile.size > 10 * 1024 * 1024) {
            toast.error("حجم الملف كبير", "حجم ملف استمارة السير يتجاوز 10 ميجابايت.");
          } else {
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    placeholder="مثال: الإدارة العامة للمرور"
                  />
                </div>
                <div>
                  <label className="mb-1 block text-sm font-semibold text-slate-700 dark:text-slate-300">
              ...
              <div>
                <label className="mb-1.5 block text-sm font-semibold text-slate-700 dark:text-slate-300">
                  إرفاق ملف استمارة السير (اختياري)
                </label>
                {!selectedFile ? (
              ...
              <div>
                ...
                <Input
                  ...
                  placeholder="ملاحظات تفصيلية حول الاستمارة..."
                />
              </div>
            </div>
          )}

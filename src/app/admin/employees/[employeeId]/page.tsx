                  ...
                  <li key={assignment.id} className="relative text-sm">
                    ...
                    {(issues.length > 0 || accidents.length > 0) && (
                      <div className="mt-2.5 flex flex-wrap gap-2">
                        {issues.length > 0 && (
                          <Link
                            href={`/admin/fleet/issues?search=${encodeURIComponent(assignment.assetNumber || assignment.vehicleId)}`}
                        ...
                        {accidents.length > 0 && (
                          <Link
                            href={`/admin/fleet/accidents?search=${encodeURIComponent(assignment.assetNumber || assignment.vehicleId)}`}
        ...
        <Card className="p-5">
          ...
          {loadingVehicleTimeline ? (
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="pt-2">
                <Link
                  href={`/admin/fleet/vehicles/${currentVehicleAssignment.vehicleId}`}

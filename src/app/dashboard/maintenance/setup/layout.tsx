...
export default function MaintenanceSetupLayout({
  children,
}: {
  ...
  const tabs = [
    ...
    {
      href: "/dashboard/maintenance/setup/items",
      label: "الأصناف وقطع الغيار",
      icon: Package,
    },
    {
      href: "/dashboard/maintenance/setup/suppliers",
      label: "الموردون",
      icon: Users,
    },
    {
      href: "/dashboard/maintenance/setup/plans",

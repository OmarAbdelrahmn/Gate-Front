...
export function Sidebar({
  ...
  const [expanded, setExpanded] = useState<Record<string, boolean>>({
    ...
    "إدارة الأسطول والمركبات": path.startsWith("/admin/fleet") && !path.startsWith("/admin/fleet/vehicle-account-assignments") && !path.startsWith("/admin/fleet/phone-sims") && !path.startsWith("/admin/fleet/accidents"),
    "إدارة الحوادث والمطالبات": path.startsWith("/admin/fleet/accidents"),

...
export const FORM_TEMPLATES: FormTemplate[] = [
  ...
  },
  {
    ...
    titleAr: "نموذج إجراء جزائي",
    titleEn: "Disciplinary Action Form",
    category: "administrative",
    categoryNameAr: "النماذج الإدارية",
    descriptionAr: "نموذج توثيق المخالفة والإجراء الجزائي المتخذ مع تعهد الموظف واعتماد الموارد البشرية والمدير العام.",
    icon: ShieldAlert,
    requiresReason: true,
    requiresDate: true,
    requiresRider: true,
  ...
  {
    id: "annual_entitlements_receipt",
    titleAr: "إقرار استلام المستحقات السنوية",
    titleEn: "Annual Entitlements Receipt Acknowledgment",
    category: "financial",
    categoryNameAr: "النماذج المالية",
    descriptionAr: "إقرار وتعهد باستلام كافة مستحقات الإجازة السنوية عن الفترة المحددة وإخلاء الطرف المالي منها.",
    icon: Banknote,
    requiresAmount: true,
    requiresDate: true,
    requiresRider: true,

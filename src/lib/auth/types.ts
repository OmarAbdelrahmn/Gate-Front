...
export type AuthUser = { id:string; employeeId:string|null; userName:string; email:string; displayNameAr:string; displayNameEn:string; preferredLocale:string; requiresPasswordChange:boolean; roles:UserRole[] };

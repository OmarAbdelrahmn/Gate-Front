...
const INITIAL_FALLBACK_TEMPLATES: HrFormTemplate[] = [
  ...
  {
    id: "01917b12-9c3f-7b89-a210-987654321004",
    code: "FINAL_SETTLEMENT_CLEARANCE",
    nameAr: "نموذج / إقرار المخالصة النهائية",
    nameEn: "Final Clearance & Settlement Declaration",
    category: "custody",
    descriptionAr: "إقرار وتعهد باستلام كافة الحقوق والمستحقات وإبراء ذمة الشركة ونقل الكفالة مدة أقصاها 30 يوماً.",
    descriptionEn: "Declaration of final clearance, dues receipt, company waiver, and sponsorship transfer undertaking.",
    isActive: true,
    currentDraftVersionId: "v-01917b12-9c3f-7b89-a210-987654321004-1",
    currentPublishedVersionId: "v-01917b12-9c3f-7b89-a210-987654321004-1",
    createdByUserId: "user-admin",
    createdAtUtc: "2026-08-15T09:00:00Z",
    updatedAtUtc: "2026-08-15T09:00:00Z",
    rowVersion: "AAAAAAAAB93=",
    currentDraftVersion: {
      id: "v-01917b12-9c3f-7b89-a210-987654321004-1",
      hrFormTemplateId: "01917b12-9c3f-7b89-a210-987654321004",
      versionNumber: 1,
      definitionSchemaVersion: 1,
      definitionJson: SAMPLE_CASH_ADVANCE_DEFINITION,
      definitionSha256: "c34...77",
      changeNote: "الإصدار الأولي لإقرار المخالصة النهائية",
      createdByUserId: "user-admin",
      createdAtUtc: "2026-08-15T09:00:00Z",
    },
    currentPublishedVersion: {
  ...
  {
    id: "01917b12-9c3f-7b89-a210-987654321005",
    code: "HR_INTERVIEW_FORM",
    nameAr: "نموذج مقابلة (خاص بالموارد البشرية)",
    nameEn: "HR Candidate Interview Form",
    category: "employment",
    descriptionAr: "نموذج مقابلة مرشح جديد وتحديد تكاليف نقل الخدمات، الإقامة، رخصة القيادة، والمهنة.",
    descriptionEn: "Candidate interview and recruitment evaluation form covering transfer, residency, and license fees.",
    isActive: true,
    currentDraftVersionId: "v-01917b12-9c3f-7b89-a210-987654321005-1",
    currentPublishedVersionId: "v-01917b12-9c3f-7b89-a210-987654321005-1",
    createdByUserId: "user-admin",
    createdAtUtc: "2026-08-16T09:00:00Z",
    updatedAtUtc: "2026-08-16T09:00:00Z",
    rowVersion: "AAAAAAAAB94=",
    currentDraftVersion: {
      id: "v-01917b12-9c3f-7b89-a210-987654321005-1",
      hrFormTemplateId: "01917b12-9c3f-7b89-a210-987654321005",
      versionNumber: 1,
      definitionSchemaVersion: 1,
      definitionJson: SAMPLE_CASH_ADVANCE_DEFINITION,
      definitionSha256: "d56...88",
      changeNote: "الإصدار الأولي لنموذج المقابلة",
      createdByUserId: "user-admin",
      createdAtUtc: "2026-08-16T09:00:00Z",
    },
    currentPublishedVersion: {
  ...
  {
    id: "01917b12-9c3f-7b89-a210-987654321006",
    code: "OPERATIONS_EVALUATION_FORM",
    nameAr: "نموذج تقييم وإقرار - إدارة التشغيل",
    nameEn: "Operations Evaluation & Undertaking Form",
    category: "employment",
    descriptionAr: "نموذج تقييم إدارة التشغيل للمندوب وتطبيقات التوصيل والخرائط، التقييم النهائي، والإقرار والتعهد.",
    descriptionEn: "Operations evaluation, delivery apps and mapping skill assessment, rating, and candidate undertaking.",
    isActive: true,
    currentDraftVersionId: "v-01917b12-9c3f-7b89-a210-987654321006-1",
    currentPublishedVersionId: "v-01917b12-9c3f-7b89-a210-987654321006-1",
    createdByUserId: "user-admin",
    createdAtUtc: "2026-08-16T10:00:00Z",
    updatedAtUtc: "2026-08-16T10:00:00Z",
    rowVersion: "AAAAAAAAB95=",
    currentDraftVersion: {
      id: "v-01917b12-9c3f-7b89-a210-987654321006-1",
      hrFormTemplateId: "01917b12-9c3f-7b89-a210-987654321006",
      versionNumber: 1,
      definitionSchemaVersion: 1,
      definitionJson: SAMPLE_CASH_ADVANCE_DEFINITION,
      definitionSha256: "e78...12",
      changeNote: "الإصدار الأولي لنموذج تقييم وإقرار إدارة التشغيل",
      createdByUserId: "user-admin",
      createdAtUtc: "2026-08-16T10:00:00Z",
    },
    currentPublishedVersion: {
